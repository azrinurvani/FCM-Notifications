    ...
    private fun startTimer(timerLengthSelection: Int) {
        _alarmOn.value?.let {
            if (!it) {
                ...
                /*pada bagian ini notifikasi di nonaktifkan karena apabila timer dijalankan, maka notifikasi terus berjalan,
                 maka dari dipindahkan ke bagian method onReceive() yang ada pada AlarmReceiver, karena notifkasi hanya akan berjalan
                 ketika timer berhenti atau broadcastReceiver nya telah jalan
                * */
